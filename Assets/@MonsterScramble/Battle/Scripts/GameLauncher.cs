...
public class GameLauncher : MonoBehaviour, INetworkRunnerCallbacks
{
    ...
    [SerializeField]
    private SealedMonsterSpawner _fieldMonsterSpawner;
    ...
    public void OnPlayerJoined(NetworkRunner runner, PlayerRef player)
    {
        ...
        //{
            ...
            GameManager.instance.SwitchGameState(GameState.Battle);
            ...
            _fieldMonsterSpawner.SpawnFieldMonster(_networkRunner);
        //}
    }
